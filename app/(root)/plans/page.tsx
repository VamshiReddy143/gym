  ...
  Male: [
    {
      ...
      accentColor: "#f97316",
      videos: [
        { title: "Men’s Bulking Power Lifts", url: "https://www.youtube.com/embed/HPg6rgSojOw" },
        { title: "Deadlift for Mass", url: "https://www.youtube.com/embed/XxWcirHIwVo" },
        { title: "Bulking Nutrition for Men", url: "https://www.youtube.com/embed/1MUqAHMY9Nk" },
      ],
      dietPlan: {
    ...
    },
    {
      ...
      accentColor: "#dc2626",
      videos: [
        { title: "Men’s HIIT Shred", url: "https://www.youtube.com/embed/Y5RtQ4cawVk" },
        { title: "Core Cutting for Men", url: "https://www.youtube.com/embed/AnDomJbHh2g" },
        { title: "Cutting Diet for Men", url: "https://www.youtube.com/embed/auQHRD8MPys" },
      ],
      dietPlan: {
    ...
    },
    {
      ...
      accentColor: "#eab308",
      videos: [
        { title: "Men’s Lean Muscle Circuit", url: "https://www.youtube.com/embed/gYfSXtK7PO4" },
        { title: "Mobility for Men", url: "https://www.youtube.com/embed/uNN62f55EV0" },
        { title: "Lean Nutrition for Men", url: "https://www.youtube.com/embed/M7xx0WejDV4" },
      ],
      dietPlan: {
  ...
  Female: [
    {
      ...
      accentColor: "#f97316",
      videos: [
        { title: "Women’s Bulking Basics", url: "https://www.youtube.com/embed/TFO9hBtLVec" },
        { title: "Glute Growth Lifts", url: "https://www.youtube.com/embed/pc5xn--jceA" },
        { title: "Nutrition for Women", url: "https://www.youtube.com/embed/gJemac0FrLo" },
      ],
      dietPlan: {
    ...
    },
    {
      ...
      accentColor: "#dc2626",
      videos: [
        { title: "Women’s Fat Loss HIIT", url: "https://www.youtube.com/embed/nFBdDaK_6Ko" },
        { title: "Core Toning for Women", url: "https://www.youtube.com/embed/Xa62Qb-er-k" },
        { title: "Cutting Nutrition Guide", url: "https://www.youtube.com/embed/TFyaM-TGCXg" },
      ],
      dietPlan: {
    ...
    },
    {
      ...
      accentColor: "#eab308",
      videos: [
        { title: "Women’s Lean Sculpt Circuit", url: "https://www.youtube.com/embed/_2kurCtiKjw" },
        { title: "Flexibility for Women", url: "https://www.youtube.com/embed/WMos5qSIasw" },
        { title: "Lean Nutrition for Women", url: "https://www.youtube.com/embed/4mjRM7sbhFk" },
      ],
      dietPlan: {
...
const PlansPage = () => {
  ...
  const planDetailsRef = useRef<HTMLDivElement>(null); // Ref to scroll to plan details
    ...
    <div className="min-h-screen bg-gray-900 text-white px-8 py-16 overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto relative z-20">
        <motion.h1
          ...
          className="text-3xl md:text-7xl font-extrabold text-center uppercase tracking-tight text-white mb-12"
        >
        ...
        {!selectedGender ? (
          <div className="flex justify-center gap-8 mb-16">
            ...
            >
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-white uppercase tracking-wide">Male</h2>
              <p className="text-gray-400 mt-2 hidden sm:block">Plans optimized for men’s physique goals.</p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 50 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-white uppercase tracking-wide">Female</h2>
              <p className="text-gray-400 mt-2 hidden sm:block">Plans tailored for women’s fitness needs.</p>
            </motion.div>
          </div>
        ) : (
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
              {plansData[selectedGender].map((plan) => (
                <motion.div
                  ...
                  initial={{ opacity: 0, y: 50 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.8, delay: 0.2 * plansData[selectedGender].indexOf(plan), ease: "easeOut" }}
                  whileHover={{ scale: 1.05, boxShadow: "0 0 20px rgba(255,255,255,0.1)" }}
                  onClick={() => handleSelectType(plan.type)}
                  className={`bg-gray-800 p-4 rounded-xl shadow-lg cursor-pointer transition-all duration-300 border border-gray-700 hover:border-${plan.accentColor}-500 ${selectedType === plan.type ? `border-${plan.accentColor}-500 scale-105` : ""}`}
                >
                  <NextImage
                    src={plan.image}
                    alt={plan.type}
            ...
            {selectedPlan && (
              <motion.div
                ref={planDetailsRef} // Attach ref to the plan details section
                initial={{ opacity: 0, y: 50 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.8, ease: "easeOut" }}
                className="bg-gray-800 p-8 mt-[7em] rounded-xl shadow-lg border border-gray-700"
              >
                <h2 className="text-2xl sm:text-4xl md:text-5xl font-extrabold text-white uppercase tracking-wide mb-8">
                ...
                <div className="w-full max-w-full mx-auto sm:px-6 lg:px-8">
                  ...
                  <div className="bg-gray-850 rounded-xl sm:p-6 shadow-lg border sm:border-gray-700 border-none">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 sm:mb-8 gap-4 sm:gap-0">
                      <h4 className="text-base sm:text-lg font-bold text-white tracking-wide">
                        {selectedPlan.dietPlan.title}
                      </h4>
                      <div className="flex flex-wrap gap-3 sm:gap-4 text-sm text-gray-300">
                        <span className="flex items-center gap-1">
                          <span className="text-orange-500 font-semibold">{selectedPlan.dietPlan.total.calories}</span> cal
                        </span>
                        <span className="flex items-center gap-1">
                          <span className="text-orange-500 font-semibold">{selectedPlan.dietPlan.total.protein}g</span> pro
                        </span>
                      </div>
                    </div>
                    <div className="space-y-4 sm:space-y-6">
                      {selectedPlan.dietPlan.meals.map((meal, index) => (
                        <motion.div
                          ...
                          className="bg-gray-900 p-4 sm:p-5 rounded-lg shadow-md flex flex-col sm:flex-row items-start sm:items-center gap-4 hover:bg-gray-880 transition-all duration-300"
                        >
                          <div className="flex-shrink-0 w-14 h-14 sm:w-16 sm:h-16 bg-gray-800 rounded-full flex items-center justify-center">
                            <FaClock className="text-orange-500 text-xl sm:text-2xl" />
                          </div>
                          <div className="flex-1 w-full">
                            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-2 gap-2">
                              <h5 className="text-base sm:text-lg font-semibold text-white">{meal.name}</h5>
                            ...
                            <div className="mt-3 flex flex-wrap justify-between text-xs text-gray-400 gap-2">
                    ...
                    <motion.div
                      ...
                      className="mt-6 sm:mt-8 p-4 bg-gray-900 rounded-lg shadow-md grid grid-cols-2 sm:grid-cols-4 gap-4 text-sm text-gray-300"
                    >
